...
export function StockTable({
  ...
  useEffect(() => {
    if (filteredData.length) {
      ...
      const indicesStocks = [
        { price: "S&P_500_Price", volume: "S&P_500_Vol.", name: "S&P 500" },
        {
          price: "Nasdaq_100_Price",
          volume: "Nasdaq_100_Vol.",
          name: "Nasdaq 100",
        },
      ];
      ...
      const commoditiesStocks = [
        ...
        { price: "Copper_Price", volume: "Copper_Vol.", name: "Copper" },
        {
          ...
          volume: "Crude_oil_Vol.",
          name: "Crude Oil",
        },
        {
          price: "Natural_Gas_Price",
          volume: "Natural_Gas_Vol.",
          name: "Natural Gas",
        },
      ];
      ...
      const financeStocks = [
        {
          price: "Berkshire_Price",
          volume: "Berkshire_Vol.",
      ...
      const data = displayStocks.map((stock) => {
        ...
        const lastValue = Number.parseFloat(
          filteredData[filteredData.length - 1][stock.price]
        );
        const change =
