...
import { CommoditiesOverview } from "@/components/commodities-overview";
    ...
    <div className="flex flex-col min-h-screen w-[98.5vw]">
      ...
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <StockPriceChart commoditiesOnly={true} />
          <MarketSentimentChart commoditiesOnly={true} />
        </div>
        <div className="grid gap-4">
          <StockTable commoditiesOnly={true} />
        </div>
      </div>
    </div>
  );
